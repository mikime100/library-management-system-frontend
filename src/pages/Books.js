      ...
      children: [
        ...
        _jsxs("div", {
          ...
          children: [
            ...
            _jsxs("button", {
              className:
                "flex items-center gap-2 bg-black text-white px-6 py-2 rounded-lg font-semibold text-lg hover:bg-gray-800 transition",
              onClick: () => setModal({ type: "add" }),
              children: [_jsx(Plus, { className: "h-5 w-5" }), " Add Book"],
            }),
          ],
        }),
        _jsx("div", {
              ...
              children: [
                ...
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    _jsx("span", {
                      className:
                        "bg-gray-100 rounded-full px-3 py-1 text-sm font-semibold",
                      children:
                ...
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    " ",
                    _jsx("span", { children: modal.book.publishedYear }),
                  ],
                }),
                _jsxs("div", {
                  className: "flex justify-between",
                  children: [
                    ...
                    _jsxs("span", {
                      className:
                        "bg-black text-white rounded-full px-3 py-1 text-sm font-semibold",
                      children: [modal.book.availableCopies, " copies"],
                    }),
                  ],
                }),
                _jsxs("div", {
            ...
            _jsxs("div", {
              ...
              children: [
                ...
                deleteError &&
                  _jsx("div", {
                    className:
                      "text-red-600 bg-red-50 border border-red-200 rounded p-2 text-sm",
                    children: deleteError,
                  }),
                deleteSuccess &&
                  _jsx("div", {
                    className:
                      "bg-green-50 border-l-4 border-green-400 p-4 mb-4",
                    children: _jsxs("div", {
                      className: "flex",
                      children: [
                        _jsx("div", {
                    ...
                    _jsx("button", {
                      ...
                      onClick: async () => {
                        ...
                        try {
                          ...
                          setModal(null);
                          toast.error(
                            `Book "${modal.book.title}" deleted successfully!`
                          );
                        } catch (err) {
